...
const TermsOfService = () => {
  useEffect(() => {
    document.title = "Terms of Service - Navya Shoe Garden";
  }, []);
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using the Navya Shoe Garden website and services, you accept and agree to be bound by the terms and provision of this agreement. These Terms of Service govern your use of our website, products, and services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Permission is granted to temporarily download one copy of the materials on Navya Shoe Garden's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Payment is due at the time of purchase. We accept Cash on Delivery (COD), UPI, Debit Cards, and Credit Cards via Razorpay. All prices are in INR unless otherwise specified.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-1">
                ...
                <li>Items must be in their original packaging and box</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our footwear comes with a 365-day warranty against manufacturing defects. This warranty does not cover damage from normal wear, improper care, or accidents. Proper care instructions are provided with each purchase and on our website.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content on this website, including but not limited to text, graphics, logos, images, and software, is the property of Navya Shoe Garden and is protected by copyright, trademark, and other intellectual property laws. Unauthorized use is prohibited.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                These terms and conditions are governed by and construed in accordance with the laws of India, and you irrevocably submit to the exclusive jurisdiction of the courts in that jurisdiction.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 text-muted-foreground">
                <p>Email: navyashoegarden6@gmail.com</p>
                <p>Phone: 9518555555</p>
              </div>
            </section>
          </div>
        </div>
